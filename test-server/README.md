...
1. test-server-app-api => `ezyfox-server/apps/common/test-server-app-api-0.1.0.jar`
2. test-server-app-entry => `ezyfox-server/apps/entries/test-server-app`
3. test-server-common => `ezyfox-server/common/ test-server-common-0.1.0.jar`
...
3. Run class `com.assambra.test.tools.ExternalLibrariesExporter` in `test-server-startup/src/test/java`
