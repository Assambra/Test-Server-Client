package com.assambra.test;

import com.assambra.test.plugin.PluginEntry;
import com.assambra.test.plugin.PluginEntryLoader;
import com.assambra.test.app.AppEntry;
import com.assambra.test.app.AppEntryLoader;
...
public class ApplicationStartup {
    ...
    public static final String ZONE_APP_NAME = "test-server";
        ...
        public EzyPluginEntry load() throws Exception {
            return new PluginEntry() {
                ...
                private String getPluginPath(EzyPluginSetting setting) {
                    Path pluginPath = Paths.get("test-server-plugin");
                    if (!Files.exists(pluginPath)) {
                        pluginPath = Paths.get("../test-server-plugin");
                    }
        ...
        public EzyAppEntry load() throws Exception {
            return new AppEntry() {
                ...
                private String getAppPath() {
                    Path pluginPath = Paths.get("test-server-app-entry");
                    if (!Files.exists(pluginPath)) {
                        pluginPath = Paths.get("../test-server-app-entry");
                    }
                    return pluginPath.toString();
                }
            };
